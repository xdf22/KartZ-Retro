...
static void Shields_OnChange(void);
static void Shields_OnChange2(void);
...
#ifdef RIDERS
static void SendCheeseCmd(void);
static void SendCheeseCmd2(void);
static void SendChipCmd(void);
static void SendChipCmd2(void);
static void SendBirdieCmd(void);
static void SendBirdieCmd2(void);
static void Got_CheeseCmd(UINT8 **cp, INT32 playernum);
static void Got_ChipCmd(UINT8 **cp, INT32 playernum);
static void Got_BirdieCmd(UINT8 **cp, INT32 playernum);
#endif
...
#ifdef RIDERS
consvar_t cv_raceitemboxes = {"race_itemboxes", "Normal", CV_NETVAR, raceitemboxes_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
#else
...
consvar_t cv_usemouse = {"use mouse", "Off", CV_SAVE|CV_CALL,usemouse_cons_t, I_StartupMouse, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_usemouse2 = {"use mouse2", "Off", CV_SAVE|CV_CALL,usemouse_cons_t, I_StartupMouse2, 0, NULL, NULL, 0, 0, NULL};
...
//
consvar_t cv_jumpshield = {"jumpshield", "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_watershield = {"watershield", "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_ringshield = {"ringshield", "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_forceshield = {"forceshield", "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_bombshield = {"bombshield", "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
//
...
#ifdef RIDERS
consvar_t cv_airtank      = {"airtank",       "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};

consvar_t cv_mkstar       = {"stars",         "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_mushroom     = {"mushrooms",     "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_shell        = {"greenshells",   "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
...
consvar_t cv_bomb         = {"bombs",         "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_thunder      = {"thunder",       "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_megamushroom = {"megamushrooms", "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};

consvar_t cv_tshell       = {"tgreenshells",  "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_tredshell    = {"tredshells",    "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_blackshell   = {"blackshells",   "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_tblackshell  = {"tblackshells",  "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_tbanana      = {"triplebananas", "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_boo	      = {"boo",			  "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_tbomb        = {"triplebombs",   "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_bbolt        = {"bluethunder",   "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_fireflower   = {"fireflowers",   "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_tmushroom    = {"tmushrooms",    "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_gmushroom    = {"goldmushrooms", "On", CV_NETVAR|CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};

consvar_t cv_katzshield   = {"srb2shields",   "On", CV_NETVAR|CV_CALL|CV_NOINIT, CV_OnOff, Shields_OnChange, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_randomshield = {"shieldsrandom", "On", CV_NETVAR|CV_CALL|CV_NOINIT, CV_OnOff, Shields_OnChange2, 0, NULL, NULL, 0, 0, NULL};
#endif
...
#ifdef RIDERS
consvar_t cv_questionbox2 = {"itemtv", "On", CV_NETVAR, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_questionbox3 = {"capsuletv", "On", CV_NETVAR, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
#endif
...
#ifdef RIDERS
static CV_PossibleValue_t numlump_cons_t[] = {{2, "MIN"}, {9, "MAX"}, {0, NULL}};
consvar_t cv_numlaps = {"numlaps", "3", CV_NETVAR|CV_CALL|CV_NOINIT, numlump_cons_t,
#else
...
consvar_t cv_downloading = {"downloading", "Off", 0, CV_OnOff, NULL, 0, NULL, NULL, 0, 0, NULL};
...
#ifdef RIDERS
	COM_AddCommand("togglecheese", SendCheeseCmd);
	COM_AddCommand("togglecheese2", SendCheeseCmd2);
	RegisterNetXCmd(XD_CHEESE, Got_CheeseCmd);
	COM_AddCommand("togglechip", SendChipCmd);
	COM_AddCommand("togglechip2", SendChipCmd2);
	RegisterNetXCmd(XD_CHIP, Got_ChipCmd);
	COM_AddCommand("togglebirdie", SendBirdieCmd);
	COM_AddCommand("togglebirdie2", SendBirdieCmd2);
	RegisterNetXCmd(XD_BIRDIE, Got_BirdieCmd);
#endif
...
#ifdef RIDERS
	CV_RegisterVar(&cv_airtank);

	CV_RegisterVar(&cv_mkstar);
	CV_RegisterVar(&cv_mushroom);
	CV_RegisterVar(&cv_shell);
	CV_RegisterVar(&cv_redshell);
	CV_RegisterVar(&cv_banana);
	CV_RegisterVar(&cv_fakeitem);
	CV_RegisterVar(&cv_bomb);
	CV_RegisterVar(&cv_thunder);
	CV_RegisterVar(&cv_megamushroom);

	CV_RegisterVar(&cv_tshell);
	CV_RegisterVar(&cv_tredshell);
	CV_RegisterVar(&cv_blackshell);
	CV_RegisterVar(&cv_tblackshell);
	CV_RegisterVar(&cv_tbanana);
	CV_RegisterVar(&cv_boo);
	CV_RegisterVar(&cv_tbomb);
	CV_RegisterVar(&cv_bbolt);
	CV_RegisterVar(&cv_fireflower);
	CV_RegisterVar(&cv_tmushroom);
	CV_RegisterVar(&cv_gmushroom);

	CV_RegisterVar(&cv_katzshield);
	CV_RegisterVar(&cv_randomshield);
	CV_RegisterVar(&cv_questionbox2);
	CV_RegisterVar(&cv_questionbox3);
#endif
}
...
static void SendNameAndColor(void)
{
	...
	{
#ifdef COLORS
		if (players[consoleplayer].ctfteam == 1 && cv_playercolor.value != 7)
			CV_StealthSetValue(&cv_playercolor, 7); // Red
		else if (players[consoleplayer].ctfteam == 2 && cv_playercolor.value != 13)
			CV_StealthSetValue(&cv_playercolor, 13); // Blue
#else
	...
	{
#ifdef COLORS
		if (cv_playercolor.value == 19) //yellow
#else
...
static void SendNameAndColor2(void)
{
	...
	{
#ifdef COLORS
		if (players[secondplaya].ctfteam == 1 && cv_playercolor2.value != 7)
			CV_StealthSetValue(&cv_playercolor2, 7);
		else if (players[secondplaya].ctfteam == 2 && cv_playercolor2.value != 13)
			CV_StealthSetValue(&cv_playercolor2, 13);
#else
	...
	{
#ifdef COLORS
		if (cv_playercolor2.value == 19) //yellow
#else
...
static void Got_NameAndColor(UINT8 **cp, INT32 playernum)
{
		...
		(p != &players[consoleplayer] && p != &players[secondarydisplayplayer]))
	{
		...
		{
#ifdef COLORS
			if (p->ctfteam == 1 && p->skincolor != 7)
				kick = true;
			else if (p->ctfteam == 2 && p->skincolor != 13)
#else
...
static void Command_Teamchange_f(void)
{
	...
	if (COM_Argc() <= 1)
	{
		if ((gametype == GT_MATCH && !cv_matchtype.value) || gametype == GT_RACE)
			CONS_Printf("%s", text[CHANGETEAM_HELP1]);
		else if (gametype == GT_CTF || (gametype == GT_RACE && cv_matchtype.value))
	...
	if ((gametype == GT_MATCH && !cv_matchtype.value) || gametype == GT_RACE)
	{
		...
		if (!players[consoleplayer].spectator && NetPacket.packet.newteam == 3)
			error = true;
	}
...
static void Got_Teamchange(UINT8 **cp, INT32 playernum)
{
	...
	if (!(gametype == GT_MATCH || gametype == GT_RACE || gametype == GT_CTF)) //Make sure you're in the right gametype.
	{
	...
	switch (gametype)
	{
	case GT_MATCH: case GT_CTF: case GT_RACE:
	...
	else if (NetPacket.packet.newteam == 3 && leveltime >= 140)
...
{
#ifdef RIDERS
	// Set the default set of laps for Single Player
	if ((!netgame || (!multiplayer && gametype != GT_RACE)) && !cv_debug)
	{
		CV_SetValue(&cv_numlaps, 3);
		return;
	}

	if (cv_numlaps.value > 2 && (netgame || multiplayer))
	{
...
static void Shields_OnChange(void)
{
	...
	if ((!netgame || (!multiplayer && gametype != GT_RACE)) && !cv_debug)
	{
		CV_SetValue(&cv_katzshield, 0);
		return;
	}

	if (cv_katzshield.value == 1)
		CONS_Printf(text[SHIELDSON]);
	else
		CONS_Printf(text[SHIELDSOFF]);
}
...
static void Shields_OnChange2(void)
{
	...
	if ((!netgame || (!multiplayer && gametype != GT_RACE)) && !cv_debug)
	{
		CV_SetValue(&cv_randomshield, 1);
		return;
	}

	if (cv_randomshield.value == 1)
		CONS_Printf(text[RANDOMSON]);
	else
		CONS_Printf(text[RANDOMSOFF]);
}
static void NetTimeout_OnChange(void)
{
...
void D_GameTypeChanged(INT32 lastgametype)
{
	...
	if (gametype == GT_CTF || gametype == GT_MATCH || gametype == GT_RACE)
	{
		INT32 i;
		for (i = 0; i < MAXPLAYERS; i++)
			if (playeringame[i])
...
static void Got_ExitLevelcmd(UINT8 **cp, INT32 playernum)
{
	...
	if (player->chip == 1)
		player->chip = 2;
	if (player->cheese == 1 || player->cheese == 3)
		player->cheese = 2;
	if (player->birdie == 1)
		player->birdie = 2;
#endif
...
#ifdef COLORS
					CV_StealthSetValue(&cv_playercolor, 25);
#else
			...
			if (gametype == GT_MATCH || gametype == GT_CTF) // yellow
			{
				...
				if (cv_playercolor.value == 15)
				{
					if (players[consoleplayer].skincolor == 1)
						...
						CV_StealthSetValue(&cv_playercolor, 1);
#else
				if (cv_playercolor.value == 19)
				{
					if (players[consoleplayer].skincolor == 20)
						CV_StealthSetValue(&cv_playercolor, 18);
					else
						CV_StealthSetValue(&cv_playercolor, 20);
#endif
				}
			}
		}
...
#ifdef COLORS
					CV_StealthSetValue(&cv_playercolor2, 25);
#else
			...
			if (gametype == GT_MATCH || gametype == GT_CTF) // yellow
			{
				...
				if (cv_playercolor2.value == 15)
				{
					if (players[secondarydisplayplayer].skincolor == 1)
						...
						CV_StealthSetValue(&cv_playercolor2, 1);
#else
				if (cv_playercolor2.value == 19)
				{
					if (players[secondarydisplayplayer].skincolor == 20)
						CV_StealthSetValue(&cv_playercolor2, 18);
					else
						CV_StealthSetValue(&cv_playercolor2, 20);
#endif
				}
			}
		}
...
static void SendCheeseCmd(void)
{
	SendNetXCmd(XD_CHEESE, NULL, 0);
}
static void SendCheeseCmd2(void)
{
	if (splitscreen)
		SendNetXCmd2(XD_CHEESE, NULL, 0);
}
...
static void SendChipCmd(void)
{
	SendNetXCmd(XD_CHIP, NULL, 0);
}
static void SendChipCmd2(void)
{
	if (splitscreen)
		SendNetXCmd2(XD_CHIP, NULL, 0);
}
...
static void SendBirdieCmd(void)
{
	SendNetXCmd(XD_BIRDIE, NULL, 0);
}
static void SendBirdieCmd2(void)
{
	if (splitscreen)
		SendNetXCmd2(XD_BIRDIE, NULL, 0);
}
