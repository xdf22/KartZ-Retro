...
static void D_Display(void)
{
	...
	// Fade to black first
#ifdef RIDERS
	if (!(gamestate == GS_MENUSCREEN || gamestate == GS_KARTSCREEN || gamestate == GS_OPTIONSCREEN))
	{
#endif
	...
	switch (gamestate)
	{
		...
		case GS_KARTSCREEN:
			F_MarioKartScreenDrawer();
			break;

		case GS_OPTIONSCREEN:
			F_OptionScreenDrawer();
			break;
#endif
	...
	if (gamestate == GS_INTRO && oldgamestate == GS_INTRO2)
		...
		wipe = true;
#ifdef RIDERS
	else if (gamestate == GS_MENUSCREEN || gamestate == GS_KARTSCREEN || gamestate == GS_OPTIONSCREEN)
		wipe = false;
#endif
...
#ifdef RIDERS
		COM_BufAddText(va("exec \"%s"PATHSEP"kartexec.cfg\" -noerror\n", srb2home));
#else
...
#ifdef RIDERS
	// Add the main file
	D_AddFile(va(pandf,srb2waddir,"246.kart"));
  //D_AddFile(va(pandf,srb2waddir,"riderslevels.kart"));

	// Add the characters
  /*D_AddFile(va(pandf,srb2waddir,"sonic.kart"));
	D_AddFile(va(pandf,srb2waddir,"tails.kart"));
	D_AddFile(va(pandf,srb2waddir,"knux.kart"));
	D_AddFile(va(pandf,srb2waddir,"amy.kart"));
	D_AddFile(va(pandf,srb2waddir,"cream.kart"));
	D_AddFile(va(pandf,srb2waddir,"jet.kart"));
	D_AddFile(va(pandf,srb2waddir,"wave.kart"));
	D_AddFile(va(pandf,srb2waddir,"shadow.kart"));
	D_AddFile(va(pandf,srb2waddir,"rouge.kart"));
	D_AddFile(va(pandf,srb2waddir,"eggman.kart"));
	D_AddFile(va(pandf,srb2waddir,"blaze.kart"));
	D_AddFile(va(pandf,srb2waddir,"silver.kart"));*/
	D_AddFile(va(pandf,srb2waddir,"chars.kart"));
	D_AddFile(va(pandf,srb2waddir,"misc.kart"));

	D_AddFile(va(pandf,srb2waddir,"kart.kart"));
#else
	// Add the players
...
#endif
#ifdef RIDERS //music.ridr
#if !defined (SDL) || defined (HAVE_MIXER)
	{
		const char *musicfile = "music1.kart";
		const char *musicpath = va(pandf,srb2waddir,musicfile);
		int ms = W_VerifyNMUSlumps(musicpath); // Don't forget the riders music!
		if (ms == 1)
		{
			D_AddFile(musicpath);
			D_AddFile(va(pandf,srb2waddir,"music2.kart"));
			D_AddFile(va(pandf,srb2waddir,"music3.kart"));
		}
		else if (ms == 0)
			I_Error("File %s has been modified with non-music lumps",musicfile);
	}
...
#ifndef RIDERS
	W_VerifyFileMD5(2, "dc5317ce5ea7a7e8cee30c23f242a593"); // sonic.plr
	W_VerifyFileMD5(3, "2b9b0d12b2993c66a591f25cbb189cf4"); // tails.plr
...
#else
	W_VerifyFileMD5(2, "30898d14490db240b22245346373e8e6");  // 246.kart
  //W_VerifyFileMD5(3, "38ae0c8cc034349ec9bab5a8901d758e");  // riderslevels.kart

  /*W_VerifyFileMD5(4, "da499a6f6d5f08c1b1c76dc0bb36dc7f");  // sonic.kart
	W_VerifyFileMD5(5, "86a1520c03cecfa99d18a88da240c53c");  // tails.kart
	W_VerifyFileMD5(6, "8eecfa2acd4d187127b1baa614954067");  // knux.kart
	W_VerifyFileMD5(7, "feaa08a8104ed20288b06beb8aa5f219");  // amy.kart
	W_VerifyFileMD5(8, "257c7f4829c2290e34cf77e12650e7c5");  // cream.kart
	W_VerifyFileMD5(9, "44c3eeeaa1aab8c80e36dec2788622c1");  // jet.kart
	W_VerifyFileMD5(10, "1a75134d803935d43dc5358129146e5f");  // wave.kart
	W_VerifyFileMD5(11, "dba088c7216796d1c839207c29a213bf");  // shadow.kart
	W_VerifyFileMD5(12, "f8bcf06224d82b8698b032c9c091afeb");  // rouge.kart
	W_VerifyFileMD5(13, "3458e969f8e63915709327db5e89a7ff");  // eggman.kart
	W_VerifyFileMD5(14, "a36a0741ff2a8ccbf6bde179e09af51c");  // blaze.kart
	W_VerifyFileMD5(15, "5af62d42534b709a3d6847da3164b34a");  // silver.kart  */
	...
	W_VerifyFileMD5(8, "8d080c050ecf03691562aa7b60156fec"); // soar.dta
	

	mainwads = 9; // there are 8 wads not to unload
#endif
	...
	if (autostart || netgame || M_CheckParm("+connect") || M_CheckParm("-connect"))
	{
		...
		if (M_CheckParm("-gametype") && M_IsNextParm())
		{
			...
			for (j = 1; gametype_cons_t[j].strvalue; j++)
#endif
