...
#ifdef RIDERS
#define VERSION 124
#define VERSIONSTRING "KART Z v12.04.23"
#else
...
#ifdef RIDERS
#define MODID 9        //v KEEP THIS DIGIT FOR SUBVERSION IF APPLICABLE
#define MODVERSION 6
#define UPDATE_ALERT
#define UPDATE_ALERT_STRING "New updates are available for SRB2Kart\nPlease visit the forums to download them.\n\nYou will not be able to connect to the\nMaster Server until you have updated to\nthe latest version!\n\nCurrent Version: %s\nLatest Version: %s"
#else
